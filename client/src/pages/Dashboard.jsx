...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-73px)] p-6 md:p-10" style={{ background: 'var(--bg-base)' }}>
      <div className="max-w-6xl mx-auto">
        ...
        {loading ? (
          <div className="flex justify-center items-center py-20">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2" style={{ borderColor: 'var(--accent-focus)' }}></div>
          </div>
        ) : error ? (
          <div className="p-6 text-center rounded-xl mt-8" style={{ background: 'var(--bg-panel)', border: '1px solid var(--border-subtle)' }}>
            <p className="font-medium" style={{ color: '#ef4444' }}>{error}</p>
          </div>
        ) : sessions.length === 0 ? (
          <div className="p-16 text-center rounded-xl mt-8" style={{ background: 'var(--bg-panel)', border: '1px solid var(--border-subtle)' }}>
