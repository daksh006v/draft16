...
const NewSession = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-[calc(100vh-73px)] p-6 md:p-10" style={{ background: 'var(--bg-base)' }}>
      <div className="w-full max-w-xl" style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border-subtle)', borderRadius: '12px', padding: '40px' }}>
        
        <div className="mb-8">
          <Link to="/dashboard" className="inline-flex items-center gap-1 text-sm font-semibold mb-6 hover:underline transition-colors" style={{ color: 'var(--accent-focus)' }}>
